...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    # end
    # primary.item :new_ad, 'Подать объявление', new_ad_path, if: -> { user_signed_in? }
    # primary.item :edit_user_registration, 'Мой профиль', edit_user_registration_path, if: -> { user_signed_in? }
    # primary.item :my_ads, 'Мои объявления', ads_path, if: -> { user_signed_in? }
    # primary.item :destroy_user_session, 'Выйти', destroy_user_session_path, method: :delete, if: -> { user_signed_in? }
